...
/script__${username}__2b - Gửi khi kết thúc bằng 2 nến MUA.
/script__${username}__2 giây - Gửi khi kết thúc bằng 2 nến BÁN.
/script__${username}__2b2s - Gửi khi nó kết thúc với 2 nến MUA & 2 nến BÁN.
  
  Đặt đơn đặt hàng tự động:
/script__${username}__2b_b10 - Mua 10 khi chuỗi tín hiệu kết thúc với 2 nến MUA.
/script__${username}__3s_s20 - Bán 20 khi chuỗi tín hiệu kết thúc với 3 nến BÁN.
...
export const SEPARATOR_SCRIPT = '__';
